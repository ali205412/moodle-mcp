...
$string['oauth:authorize_approve'] = 'Allow Claude';
$string['oauth:authorize_cancel'] = 'Cancel';
$string['oauth:authorize_denied'] = 'The authorization request was denied.';
$string['oauth:authorize_heading'] = 'Authorize Moodle MCP access';
$string['oauth:authorize_intro'] = '{$a} is requesting access to Moodle through the MCP connector with the following scopes:';
$string['oauth:authorize_resource'] = 'Requested MCP server: {$a}';
...
$string['settings:oauthenabled'] = 'Enable OAuth authorization server';
$string['settings:oauthenabled_desc'] = 'Expose Claude-compatible OAuth authorization, token, registration, and discovery endpoints for the MCP transport.';
